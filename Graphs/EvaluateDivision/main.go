...
func calcEquation(equations [][]string, values []float64, queries [][]string) []float64 {
	...
	// Compute/Process the passed in params equations & values to build-up a directed weighted graph structure
	// where:
	//	 1. Nodes/Vertices are values given in the equations params,
